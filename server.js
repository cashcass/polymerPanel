...
var jsonServer   = require('node_modules/json-server/src/server/index');
var server       = jsonServer.create();
var router       = jsonServer.router('demo-server/db.json');

// Authentication Libraries - Start
var cookieParser = require('node_modules/cookie-parser/index');
var session      = require('node_modules/express-session/index');
